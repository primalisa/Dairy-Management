  ...
  <img src="logo1.png" alt="Image">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <table border="1" cellspacing="5" cellpadding="5" align="center">
                <tr><th>Farmer No.</th><th>Name</th><th>Address</th><th>Milk Type</th></tr>
                <tr>
                    <td align="center"><input type="text" name="ssn" id="ssn" size="20" maxlength="20"></td>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Insert to database
            if ($ssn && $name && $address) {
                mysqli_query($mysql, "INSERT INTO farmer VALUES('$ssn','$name','$address','$mtype')");
            }
            
// Get next customer No
            $result2 = mysqli_query($mysql, "SELECT * FROM farmer ORDER BY ssn DESC");
            ...
            <?php
            $result3 = mysqli_query($mysql, "SELECT * FROM farmer ORDER BY ssn DESC");
